...
#include <vector>
	...
	class solver
	{
		...
		std::vector<double> Mid_diag_coeff(mesh grid, double theta,bool A,double theta,std::vector<double> sigma, std::vector<double> rate); 
		std::vector<double> Upper_diag_coeff(mesh grid, double theta,bool A,double theta,std::vector<double> sigma, std::vector<double> rate);
		std::vector<double> Lower_diag_coeff(mesh grid, double theta,bool A,double theta,std::vector<double> sigma, std::vector<double> rate);
