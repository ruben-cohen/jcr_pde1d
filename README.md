...
```bash
git clone https://github.com/JohnDoe/jcr_pde1d.git
cd jcr_pde1d
git remote add upstream https://github.com/JohanMabille/jcr_pde1d.git
```
...
First, be sure you master is up to date; on your remote fork on github (here `JohnDoe/jcr_pde1d`)
you should see `This branch is even with JohanMabille/jcr_pde1d`. If not, you need to update:
